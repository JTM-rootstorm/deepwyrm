...
#[test]
fn task_authority_compile_fail_contracts() {
...
fn run_compile_fail_case(
    ...
    let output = Command::new(rustc)
        ...
        .env("DEEPWYRM_E3_THREAD_STACK_SIZE", "65536")
    ...
    assert!(
        ...
        "{} unexpectedly compiled; move-only task authority widened",
        fixture.display()
    );
    ...
    assert_eq!(
        first_error,
        case.expected_error,
        "{} failed with unexpected first error:\n{}",
        fixture.display(),
        stderr
    );
}
